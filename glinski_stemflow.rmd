...
- a single plot stacked concentration versus time for all sites (all 10 tifton pond sites)
- a single plot concentration versus time plots for stemflow and throughfall by site, 6 different symbol/color/filled)
...
for(chem in chems_we_care_about){
  ...
  plot(chem_merge$amount_inches, chem_merge$Conc.x, main='stemflow')
  #1 plot by date (all together, with 3 different symbols/colors for site and filled/not filled for sf v tf)
  plot(chem_merge$Date, chem_merge$Conc.y, title='throughfall')
